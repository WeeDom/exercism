...
class PangramTest(unittest.TestCase):
    ...
    def test_mixed_case_and_punctuation(self):
        # I've changed this test as I think it was incorrect. The README says:
        # The alphabet used consists of ASCII letter a to z.
        #it makes no mention of punction being accepted
        self.assertIs(is_pangram('"Five quacking Zephyrs jolt my wax bed."'), False)
